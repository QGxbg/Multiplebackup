#!/bin/bash
# simulation experiment for varying agentsnum
...
cd $proj_dir
rm ${log_dir}/varying_agentsnum/*
rm ${ret_dir}/varying_agentsnum/*

ecn=14
eck=10
ecw=256

for agents_num in {20,30,40,50,60,70,80,90}; do 
    batchsize=$((agents_num-1))
    centralize_scatter_log="$log_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_centralize_scatter"
    centralize_scatter_ret="$ret_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_centralize_scatter"
    offline_scatter_log="$log_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_offline_scatter"
    offline_scatter_ret="$ret_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_offline_scatter"
    parallel_scatter_log="$log_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_parallel_scatter"
    parallel_scatter_ret="$ret_dir/varying_agentsnum/${code}_${ecn}_${eck}_${ecw}_${agents_num}_parallel_scatter"


    for j in {1..10}; do
        echo "for agents_num = $agents_num ":"$j times"
