...
int main(int argc, char** argv) {
    ...
    // OfflineSolution* sol_offline = new OfflineSolution();
...
//   cout << endl;
    ...
    if(fail_num == 1){
        sol ->genColoringForSingleFailure(currStripe, coloring, failnodeids[0], num_agents, scenario, placement);
    }else{
        //sol->genColoringForMultipleFailureLevel(currStripe, coloring, failnodeids, num_agents, scenario, placement,method);
    ...
    //sol->genColoringForMultipleFailureLevel(currStripe, coloring, failnodeids, num_agents, "scatter", placement,greedy);
    
    //sol_offline ->genOfflineColoringForMultipleFailure(currStripe, coloring, failnodeids, num_agents, "scatter");
    ...
    currStripe ->dumpLoad(sol->_cluster_size);
